...
namespace ProjectCore.Generator {
    
    using TState = ProjectCoreState;
    using ProjectCore.Modules;
    using ME.ECS;
    using ME.ECS.Views.Providers;
    using ProjectCore.Generator.Modules;
    ...
    public sealed class ProjectCoreInitializer : InitializerBase {
